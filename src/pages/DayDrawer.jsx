        ...
        <div className="p-4 space-y-3 overflow-y-auto">
            {events.length > 0 ? events.map(event => (
                <button 
                    ...
                    className="w-full text-left flex items-center p-3 rounded-lg hover:bg-gray-50 border"
                >
                    <div className="flex-shrink-0 w-2 h-2 rounded-full mr-3" style={{ backgroundColor: getEventTypeStyle(event.leaveType).replace('bg-', '') }}></div>
                    <div>
